...
var Model = class extends CustomType {
  constructor(route, layout, storage, confirmed, albums, player, queue2, current_song, seeking, seek_amount, played_seconds, looping) {
    super();
    this.route = route;
    this.layout = layout;
  ...
  if (msg instanceof Router) {
    ...
    if ($ instanceof Ok) {
      ...
      if ($1 instanceof Album3) {
        ...
        let auth_details = _block;
        echo6(m.queue.position + 1, void 0, "src/somachord.gleam", 336);
        let _block$1;
        let _pipe = songs;
        let _pipe$1 = filter(
          _pipe,
        ...
        echo6(queue2.changed, void 0, "src/somachord.gleam", 150);
        return [
          new Model(
            m.route,
            m.layout,
        ...
        let auth_details = _block;
        echo6(attempted_path, void 0, "src/somachord.gleam", 374);
        echo6(code2, void 0, "src/somachord.gleam", 375);
        echo6(message2, void 0, "src/somachord.gleam", 376);
      ...
      let e = $[0];
      echo6(e, void 0, "src/somachord.gleam", 183);
      return [m, none2()];
    }
    ...
    if ($ === "album") {
      return guard(
        ...
        [
          ...
          from(
            (dispatch) => {
              echo6("already have album", void 0, "src/somachord.gleam", 198);
              let _block$1;
              let _pipe = m.albums;
...
function player_event_handler(event4, player) {
  if (event4 === "loaded") {
    ...
    echo6(event4, void 0, "src/somachord.gleam", 495);
    throw makeError(
      "panic",
      FILEPATH12,
      "somachord",
